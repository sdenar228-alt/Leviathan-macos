...
MACRO_CONFIG_STR(ClLanguagefile, cl_languagefile, 255, "languages/russian.txt", CFGFLAG_CLIENT | CFGFLAG_SAVE, "What language file to use")
...
#include "config_variables_custom.h"
